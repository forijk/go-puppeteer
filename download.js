...
const SOURCE_URL = 'https://juejin.im/post/5daeefc8e51d4524f007fb15';
...
const printIturingBooks = async (userName, password, saveDir = './books/') => {
  ...
  try {
    ...
    axios.post('https://juejin.im/auth/type/phoneNumber', postData).then(res => {
      console.log(res);
    })
    ...
    // const res = await fetch('https://juejin.im/auth/type/phoneNumber', {
    //   method: 'POST',
    //   body: formData
    // }).then(res => {
    //   console.log(res);
